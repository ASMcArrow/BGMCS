...
private:
    ...
    G4int NumTrack;
    G4int I, NumMat;
    G4double Ranges[20] = {11.3912574204*cm, 16.9612403101*cm, 8.6801801802*cm, 14.7225*cm, 15.2168141593*cm, 14.6533333333*cm, 19759*cm, 9.5490909091*cm,
    ...
    G4String Materials[20] = {"Beryllium", "Polystyrene",  "Carbon", "Lexan", "Nylon", "Lucite",  "Air", "Teflon", "Aluminum", "Silicon",
